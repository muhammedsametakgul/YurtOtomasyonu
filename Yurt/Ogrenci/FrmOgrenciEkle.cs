...
namespace Yurt
{
    public partial class FrmOgrenciEkle : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand komut3= new SqlCommand("insert into Borclar1 (OgrenciTc,OgrenciAd,OgrenciMail) " +
                "values (@b1,@b2,@b3)",sql.Baglan());
            ...
            SqlCommand komut4 = new SqlCommand("insert into IzınHakkı(OgrenciTc,OgrenciAd,OgrenciTel) values (@i1,@i2,@i3)",sql.Baglan());
            komut4.Parameters.AddWithValue("@i1",MskTc.Text);
            komut4.Parameters.AddWithValue("@i2",TxtAd.Text);
            komut4.Parameters.AddWithValue("@i3",MskTel.Text);
